...
<body>
            ...
            <div class="form-section">
                ...
                <div class="row-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="final_gpa" id="final_gpa" inputmode="decimal" pattern="[0-9.]*" value="<?php echo htmlspecialchars($form_data['final_gpa'] ?? ''); ?>" required placeholder="معدل را وارد کنید (مثلاً 18.50)" class="<?php echo isset($errors['final_gpa']) ? 'error-field' : ''; ?>">
                        <span class="help-text">عدد بین ۰ تا ۲۰ با دو رقم اعشار - برای اعشار از نقطه (.) استفاده کنید</span>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ====== تبدیل اعداد فارسی و عربی به انگلیسی در تمام فیلدهای عددی ======
            document.querySelectorAll('input[inputmode="numeric"], input[inputmode="decimal"], input[type="tel"], input[type="number"]').forEach(function(input) {
