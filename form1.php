        ...
        <form method="POST" action="form.php" id="registration-form" novalidate>
            ...
            <div class="form-section">
                ...
                <div class="row-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="national_code" id="national_code" maxlength="10" value="<?php echo htmlspecialchars($form_data['national_code'] ?? ''); ?>" required placeholder="کد ملی خود را وارد کنید" class="<?php echo isset($errors['national_code']) ? 'error-field' : ''; ?>">
            ...
            <div class="form-section">
                ...
                <div class="row-2">
                    <div class="form-group">
                        <label>کد پستی</label>
                        <input type="text" name="postal_code" id="postal_code" maxlength="10" value="<?php echo htmlspecialchars($form_data['postal_code'] ?? ''); ?>" placeholder="۱۰ رقم" class="<?php echo isset($errors['postal_code']) ? 'error-field' : ''; ?>">
                        <span class="help-text">۱۰ رقم</span>
                    </div>
                    <div class="form-group">
                        <label>شماره تلفن ثابت</label>
                        <input type="text" name="phone_number" id="phone_number" value="<?php echo htmlspecialchars($form_data['phone_number'] ?? ''); ?>" placeholder="شماره تلفن را وارد کنید">
                    </div>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="row-2">
                    <div class="form-group">
                        <label>کد ملی <span class="required">*</span></label>
                        <input type="text" name="father_national_code" id="father_national_code" maxlength="10" value="<?php echo htmlspecialchars($form_data['father_national_code'] ?? ''); ?>" required placeholder="کد ملی پدر را وارد کنید" class="<?php echo isset($errors['father_national_code']) ? 'error-field' : ''; ?>">
                        <span class="help-text">۱۰ رقم معتبر</span>
                    </div>
                    <div class="form-group">
                        <label>شماره شناسنامه</label>
                        <input type="text" name="father_id_card" id="father_id_card" value="<?php echo htmlspecialchars($form_data['father_id_card'] ?? ''); ?>" placeholder="شماره شناسنامه را وارد کنید">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="father_phone" id="father_phone" value="<?php echo htmlspecialchars($form_data['father_phone'] ?? ''); ?>" placeholder="شماره تماس پدر را وارد کنید">
                </div>
                ...
                <div class="form-group">
                    <label>کد ملی <span class="required">*</span></label>
                    <input type="text" name="mother_national_code" id="mother_national_code" maxlength="10" value="<?php echo htmlspecialchars($form_data['mother_national_code'] ?? ''); ?>" required placeholder="کد ملی مادر را وارد کنید" class="<?php echo isset($errors['mother_national_code']) ? 'error-field' : ''; ?>">
                    <span class="help-text">۱۰ رقم معتبر</span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="mother_phone" id="mother_phone" value="<?php echo htmlspecialchars($form_data['mother_phone'] ?? ''); ?>" placeholder="شماره تماس مادر را وارد کنید">
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row-2">
                    <div class="form-group">
                        ...
                        <input type="number" name="total_children" id="total_children" min="1" max="20" value="<?php echo htmlspecialchars($form_data['total_children'] ?? ''); ?>" required placeholder="تعداد فرزندان را وارد کنید" class="<?php echo isset($errors['total_children']) ? 'error-field' : ''; ?>">
                    </div>
                    <div class="form-group">
                        <label>دانش‌آموز فرزند چندم است؟</label>
                        <input type="number" name="child_order" id="child_order" min="1" max="20" value="<?php echo htmlspecialchars($form_data['child_order'] ?? ''); ?>" placeholder="ترتیب فرزند را وارد کنید" class="<?php echo isset($errors['child_order']) ? 'error-field' : ''; ?>">
                ...
                <div class="row-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="emergency_phone" id="emergency_phone" value="<?php echo htmlspecialchars($form_data['emergency_phone'] ?? ''); ?>" placeholder="شماره تماس را وارد کنید">
                    </div>
                    <div class="form-group">
                        <label>شماره شاد</label>
                        <input type="text" name="shad_id" id="shad_id" value="<?php echo htmlspecialchars($form_data['shad_id'] ?? ''); ?>" placeholder="شماره شاد را وارد کنید">
                    </div>
                </div>
                <div class="row-2">
                    <div class="form-group">
                        <label>شماره بله</label>
                        <input type="text" name="bale_id" id="bale_id" value="<?php echo htmlspecialchars($form_data['bale_id'] ?? ''); ?>" placeholder="شماره بله را وارد کنید">
                    </div>
                    <div class="form-group">
                        <label>شماره ایتا</label>
                        <input type="text" name="eita_id" id="eita_id" value="<?php echo htmlspecialchars($form_data['eita_id'] ?? ''); ?>" placeholder="شماره ایتا را وارد کنید">
                    </div>
                </div>
            </div>
